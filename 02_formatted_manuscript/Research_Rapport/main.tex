...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Pictures/combined_XY_relbias_RMSE_1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Pictures/combined_XY_relbias_RMSE.png}
